...
static const char *const yytname[] =
{
  ...
  "TOK_NE", "'?'", "':'", "'|'", "'&'", "'='", "'<'", "'>'", "'~'", "','",
  "'-'", "'+'", "'*'", "'/'", "'%'", "NEG", "'^'", "'['", "']'", "'('",
  "')'", "$accept", "expression", "exp_list", "one_exp", "exp", YY_NULL
};
#endif
...
/* Line 1575 of yacc.c  */
#line 96 "../../../src/frontend/parse-bison.y"
{
    yylval.num = 0.0;
    yylloc.start = yylloc.stop = NULL;
}
/* Line 1575 of yacc.c  */
#line 1434 "parse-bison.c"
  yyvsp[0] = yylval;
  yylsp[0] = yylloc;
  goto yysetstate;
  ...
  switch (yyn)
    {
        case 2:
/* Line 1792 of yacc.c  */
#line 108 "../../../src/frontend/parse-bison.y"
    { *retval = NULL; }
    break;

  case 3:
/* Line 1792 of yacc.c  */
#line 109 "../../../src/frontend/parse-bison.y"
    { *retval = (yyvsp[(1) - (1)].pnode); }
    break;

  case 5:
/* Line 1792 of yacc.c  */
#line 114 "../../../src/frontend/parse-bison.y"
    { (yyvsp[(1) - (2)].pnode)->pn_next = (yyvsp[(2) - (2)].pnode); (yyvsp[(2) - (2)].pnode)->pn_use ++; (yyval.pnode) = (yyvsp[(1) - (2)].pnode); }
    break;

  case 6:
/* Line 1792 of yacc.c  */
#line 118 "../../../src/frontend/parse-bison.y"
    {
  ...
  case 7:
/* Line 1792 of yacc.c  */
#line 125 "../../../src/frontend/parse-bison.y"
    { (yyval.pnode) = PP_mknnode((yyvsp[(1) - (1)].num)); }
    break;

  case 8:
/* Line 1792 of yacc.c  */
#line 126 "../../../src/frontend/parse-bison.y"
    { (yyval.pnode) = PP_mksnode((yyvsp[(1) - (1)].str)); txfree((yyvsp[(1) - (1)].str)); }
    break;

  case 9:
/* Line 1792 of yacc.c  */
#line 128 "../../../src/frontend/parse-bison.y"
    { (yyval.pnode) = PP_mkbnode(PT_OP_COMMA,  (yyvsp[(1) - (3)].pnode), (yyvsp[(3) - (3)].pnode)); }
    break;

  case 10:
/* Line 1792 of yacc.c  */
#line 129 "../../../src/frontend/parse-bison.y"
    { (yyval.pnode) = PP_mkbnode(PT_OP_PLUS,   (yyvsp[(1) - (3)].pnode), (yyvsp[(3) - (3)].pnode)); }
    break;

  case 11:
/* Line 1792 of yacc.c  */
#line 130 "../../../src/frontend/parse-bison.y"
    { (yyval.pnode) = PP_mkbnode(PT_OP_MINUS,  (yyvsp[(1) - (3)].pnode), (yyvsp[(3) - (3)].pnode)); }
    break;

  case 12:
/* Line 1792 of yacc.c  */
#line 131 "../../../src/frontend/parse-bison.y"
    { (yyval.pnode) = PP_mkbnode(PT_OP_TIMES,  (yyvsp[(1) - (3)].pnode), (yyvsp[(3) - (3)].pnode)); }
    break;

  case 13:
/* Line 1792 of yacc.c  */
#line 132 "../../../src/frontend/parse-bison.y"
    { (yyval.pnode) = PP_mkbnode(PT_OP_MOD,    (yyvsp[(1) - (3)].pnode), (yyvsp[(3) - (3)].pnode)); }
    break;

  case 14:
/* Line 1792 of yacc.c  */
#line 133 "../../../src/frontend/parse-bison.y"
    { (yyval.pnode) = PP_mkbnode(PT_OP_DIVIDE, (yyvsp[(1) - (3)].pnode), (yyvsp[(3) - (3)].pnode)); }
    break;

  case 15:
/* Line 1792 of yacc.c  */
#line 134 "../../../src/frontend/parse-bison.y"
    { (yyval.pnode) = PP_mkbnode(PT_OP_POWER,  (yyvsp[(1) - (3)].pnode), (yyvsp[(3) - (3)].pnode)); }
    break;
...
#line 136 "../../../src/frontend/parse-bison.y"
  ...
  case 17:
/* Line 1792 of yacc.c  */
#line 138 "../../../src/frontend/parse-bison.y"
    { (yyval.pnode) = PP_mkunode(PT_OP_UMINUS, (yyvsp[(2) - (2)].pnode)); }
    break;

  case 18:
/* Line 1792 of yacc.c  */
#line 139 "../../../src/frontend/parse-bison.y"
    { (yyval.pnode) = PP_mkunode(PT_OP_NOT, (yyvsp[(2) - (2)].pnode)); }
    break;

  case 19:
/* Line 1792 of yacc.c  */
#line 141 "../../../src/frontend/parse-bison.y"
    { (yyval.pnode) = PP_mkfnode((yyvsp[(1) - (4)].str), (yyvsp[(3) - (4)].pnode));
  ...
  case 20:
/* Line 1792 of yacc.c  */
#line 147 "../../../src/frontend/parse-bison.y"
    { (yyval.pnode) = PP_mkbnode(PT_OP_EQ, (yyvsp[(1) - (3)].pnode), (yyvsp[(3) - (3)].pnode)); }
    break;

  case 21:
/* Line 1792 of yacc.c  */
#line 148 "../../../src/frontend/parse-bison.y"
    { (yyval.pnode) = PP_mkbnode(PT_OP_NE, (yyvsp[(1) - (3)].pnode), (yyvsp[(3) - (3)].pnode)); }
    break;

  case 22:
/* Line 1792 of yacc.c  */
#line 149 "../../../src/frontend/parse-bison.y"
    { (yyval.pnode) = PP_mkbnode(PT_OP_GT, (yyvsp[(1) - (3)].pnode), (yyvsp[(3) - (3)].pnode)); }
    break;

  case 23:
/* Line 1792 of yacc.c  */
#line 150 "../../../src/frontend/parse-bison.y"
    { (yyval.pnode) = PP_mkbnode(PT_OP_LT, (yyvsp[(1) - (3)].pnode), (yyvsp[(3) - (3)].pnode)); }
    break;

  case 24:
/* Line 1792 of yacc.c  */
#line 151 "../../../src/frontend/parse-bison.y"
    { (yyval.pnode) = PP_mkbnode(PT_OP_GE, (yyvsp[(1) - (3)].pnode), (yyvsp[(3) - (3)].pnode)); }
    break;

  case 25:
/* Line 1792 of yacc.c  */
#line 152 "../../../src/frontend/parse-bison.y"
    { (yyval.pnode) = PP_mkbnode(PT_OP_LE, (yyvsp[(1) - (3)].pnode), (yyvsp[(3) - (3)].pnode)); }
    break;

  case 26:
/* Line 1792 of yacc.c  */
#line 154 "../../../src/frontend/parse-bison.y"
    { (yyval.pnode) = PP_mkbnode(PT_OP_AND, (yyvsp[(1) - (3)].pnode), (yyvsp[(3) - (3)].pnode)); }
    break;

  case 27:
/* Line 1792 of yacc.c  */
#line 155 "../../../src/frontend/parse-bison.y"
    { (yyval.pnode) = PP_mkbnode(PT_OP_OR,  (yyvsp[(1) - (3)].pnode), (yyvsp[(3) - (3)].pnode)); }
    break;

  case 28:
/* Line 1792 of yacc.c  */
#line 157 "../../../src/frontend/parse-bison.y"
    { (yyval.pnode) = PP_mkbnode(PT_OP_INDX,  (yyvsp[(1) - (4)].pnode), (yyvsp[(3) - (4)].pnode)); }
    break;

  case 29:
/* Line 1792 of yacc.c  */
#line 158 "../../../src/frontend/parse-bison.y"
    { (yyval.pnode) = PP_mkbnode(PT_OP_RANGE, (yyvsp[(1) - (6)].pnode), (yyvsp[(4) - (6)].pnode)); }
    break;

  case 30:
/* Line 1792 of yacc.c  */
#line 159 "../../../src/frontend/parse-bison.y"
    { (yyval.pnode) = PP_mkbnode(PT_OP_TERNARY,(yyvsp[(1) - (5)].pnode),
                                                     PP_mkbnode(PT_OP_COMMA,(yyvsp[(3) - (5)].pnode),(yyvsp[(5) - (5)].pnode))); }
    break;


/* Line 1792 of yacc.c  */
#line 1799 "parse-bison.c"
      default: break;
    }
...
/* Line 2055 of yacc.c  */
#line 163 "../../../src/frontend/parse-bison.y"
